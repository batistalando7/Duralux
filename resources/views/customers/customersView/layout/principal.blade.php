...
<body>
   ...
   @include('customers.customers.parcial.header')
    @include('customers.customers.parcial.menu')
    <main class="nxl-container">
        @yield('content-customers')
        @include('customers.customers.parcial.footer')
    </main>
    @include('customers.customers.parcial.thema')

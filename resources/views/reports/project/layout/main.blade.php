...
<head>
    ...
    <!--! BEGIN: Apps Title-->
    <title>Duralux || Project Report</title>
    <!--! END:  Apps Title-->
    <!--! BEGIN: Favicon-->
...
@include('reports.project.parcial.footer')
    ...
    <script src="{{url('assets/vendors/js/jquery.calendar.min.js')}}"></script>
    <!--! END: Vendors JS !-->
    <!--! BEGIN: Apps Init  !-->
    <script src="{{url('assets/js/common-init.min.js')}}"></script>
    <script src="{{url('assets/js/reports-project-init.min.js')}}"></script>
    <!--! END: Apps Init !-->

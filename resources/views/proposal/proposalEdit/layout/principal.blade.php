...
<body>
    ...
    @include('proposal.proposalEdit.parcial.header')
    @include('proposal.proposalEdit.parcial.menu')
    <main class="nxl-container">
        @yield('content-proposalEdit')
        @include('proposal.proposalEdit.parcial.footer')
    </main>
    @include('proposal.proposalEdit.parcial.thema')

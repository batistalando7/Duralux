...
<body>
@include('proposal.proposal.parcial.header')
@include('proposal.proposal.parcial.menu')

    <main class="nxl-container">
        @yield('content-proposal')
    </main>

@include('proposal.proposal.parcial.thema')
@include('proposal.proposal.parcial.footer')

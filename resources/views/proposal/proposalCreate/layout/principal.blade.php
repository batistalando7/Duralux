...
<body>
    ...
    @include('proposal.proposalCreatet.parcial.header')
    @include('proposal.proposalCreatet.parcial.menu')
    <main class="nxl-container">
        @yield('content-proposalCreatet')
        @include('proposal.proposalCreatet.parcial.footer')
    </main>
    @include('proposal.proposalCreatet.parcial.thema')

...
<body>
   ...
   @include('Admin.customers.customers.parcial.header')
    @include('Admin.customers.customers.parcial.menu')
    <main class="nxl-container">
        @yield('content-customers')
        @include('Admin.customers.customers.parcial.footer')
    </main>
    @include('Admin.customers.customers.parcial.thema')

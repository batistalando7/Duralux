...
<body>
    ...
    @include('Admin.customers.customersCreate.parcial.header')
    @include('Admin.customers.customersCreate.parcial.menu')
    <main class="nxl-container">
        @yield('content-customersCreate')
        @include('Admin.customers.customersCreate.parcial.footer')
    </main>
    @include('Admin.customers.customersCreate.parcial.thema')

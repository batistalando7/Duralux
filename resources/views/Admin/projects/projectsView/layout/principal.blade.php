...
<body>
    ...
    @include('Admin.projects.projectsView.parcial.header')
    @include('Admin.projects.projectsView.parcial.menu')
    <main class="nxl-container">
        @yield('content-projectsView')
        @include('Admin.projects.projectsView.parcial.footer')
    </main>
    @include('Admin.projects.projectsView.parcial.thema')

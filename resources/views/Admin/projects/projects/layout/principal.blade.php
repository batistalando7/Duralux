...
<body>
    @include('Admin.projects.projects.parcial.header')
    @include('Admin.projects.projects.parcial.menu')
    <main class="nxl-container">
        @yield('content-projects')
        @include('Admin.projects.projects.parcial.footer')
    </main>
    @include('Admin.projects.projects.parcial.thema')

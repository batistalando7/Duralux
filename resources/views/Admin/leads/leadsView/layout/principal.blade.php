...
<body>
    ...
    @include('Admin.leads.leads.parcial.header')
    @include('Admin.leads.leads.parcial.menu')
    <main class="nxl-container">
        @yield('content-leads')
        @include('Admin.leads.leads.parcial.footer')
    </main>
    @include('Admin.leads.leads.parcial.thema')

...
<body>
    @include('dashboard.Analytics.parcial.header')
    @include('dashboard.Analytics.parcial.menu')

    <main class="nxl-container">
        @yield('content-Analytics')

        @include('dashboard.Analytics.parcial.thema')
        @include('dashboard.Analytics.parcial.footer')
    </main>

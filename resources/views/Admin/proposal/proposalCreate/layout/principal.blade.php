...
<body>
    ...
    @include('Admin.proposal.proposalCreatet.parcial.header')
    @include('Admin.proposal.proposalCreatet.parcial.menu')
    <main class="nxl-container">
        @yield('content-proposalCreatet')
        @include('Admin.proposal.proposalCreatet.parcial.footer')
    </main>
    @include('Admin.proposal.proposalCreatet.parcial.thema')
    ...
    <script src="{{ url('assets/js/proposal-create-init.min.js')}}"></script>
    <!--! END: Apps Init !-->
...
<!-- Mirrored from bestwpware.com/html/tf/duralux-demo/proposal-create.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Jul 2025 12:20:35 GMT -->

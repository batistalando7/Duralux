...
<body>
    @include('Admin.proposal.proposalView.parcial.header')
    @include('Admin.proposal.proposalView.parcial.menu')
    <main class="nxl-container">
    @yield('content-proposalView')
    @include('Admin.proposal.proposalView.parcial.footer')
    </main>
    @include('Admin.proposal.proposalView.parcial.thema')

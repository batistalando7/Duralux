...
<body>
    @include('Admin.payment.invoiceView.parcial.header')
    @include('Admin.payment.invoiceView.parcial.menu')
    <main class="nxl-container">
        @yield('content-invoiceView')
        @include('Admin.payment.invoiceView.parcial.footer')
    </main>
    @include('Admin.payment.invoiceView.parcial.thema')

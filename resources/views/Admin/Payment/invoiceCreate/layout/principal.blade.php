...
<body>
    @include('Admin.payment.invoiceCreate.parcial.header')
    @include('Admin.payment.invoiceCreate.parcial.menu')
    <main class="nxl-container">
        @yield('content-invoiceCreate')
        @include('Admin.payment.invoiceCreate.parcial.footer')
    </main>
    @include('Admin.payment.invoiceCreate.parcial.thema')

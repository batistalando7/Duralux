<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from bestwpware.com/html/tf/duralux-demo/auth-register-creative.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Jul 2025 12:20:58 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    ...
    @include('Admin.authentication.register.creative.parcial.themes')

    <div>
        @yield('content-auth-register-creative')
    </div>

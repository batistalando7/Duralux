<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from bestwpware.com/html/tf/duralux-demo/auth-login-creative.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Jul 2025 12:20:57 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    ...
    @include('Admin.authentication.login.creative.parcial.themes')

    <div>
        @yield('content-auth-login')
    </div>

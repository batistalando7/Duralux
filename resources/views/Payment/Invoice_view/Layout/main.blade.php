...
<body>
   @include('Payment.Invoice_view.partial.header')
   @include('Payment.Invoice_view.partial.menu') 
   @include('Payment.Invoice_view.partial.theme')

    <div>
        @yield('conteiner_invoice_view')
    </div>
   @include('Payment.Invoice_view.Layout.footer')

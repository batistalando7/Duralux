...
<body>
     ...
     <!--! [Start] Header !-->
    <!--! ================================================================ !-->
    @include('Payment.Inovoice_view.Parcial.header')
    <!--! ================================================================ !-->
    <!--! [Start] Menu !-->
    @include('Payment.Inovoice_view.Parcial.menu')
    <!--! ================================================================ !-->
    <!--! [Start] Theme !-->
    <!--! ================================================================ !-->
    @include('Payment.Inovoice_view.Parcial.theme')
    <!--! ================================================================ !-->

    <div>
        @yield('container_Inovoice_view')
    </div>

           <!-- [ Footer ] start -->
   @include('Payment.Inovoice_view.parcial.footer')
        <!-- [ Footer ] end --> 
    <!--! Footer Script !-->
    <!--! ================================================================ !-->
    <!--! BEGIN: Vendors JS !-->

...
<body>
   @include('Payment.Invoice_create.Layout.partial.header')
   @include('Payment.Invoice_create.Layout.partial.menu') 
   @include('Payment.Invoice_create.Layout.partial.theme')

    <div>
        @yield('conteiner_invoice_create')
    </div>
...
<body>
     ...
     <!--! [Start] Header !-->
    <!--! ================================================================ !-->
    @include('Payment.Inovoice_create.Parcial.header')
    <!--! ================================================================ !-->
    <!--! [Start] Menu !-->
    @include('Payment.Inovoice_create.Parcial.menu')
    <!--! ================================================================ !-->
    <!--! [Start] Theme !-->
    <!--! ================================================================ !-->
    @include('Payment.Inovoice_create.Parcial.theme')
    <!--! ================================================================ !-->

    <div>
        @yield('container_Inovoice_create')
    </div>

           <!-- [ Footer ] start -->
   @include('Payment.Inovoice_create.parcial.footer')
        <!-- [ Footer ] end --> 
    <!--! Footer Script !-->
    <!--! ================================================================ !-->
    <!--! BEGIN: Vendors JS !-->
